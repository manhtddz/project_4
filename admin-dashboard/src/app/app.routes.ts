...
export const routes: Routes = [
  ...
  // dashboard routes
  { path: 'dashboard', component: AdminOverviewComponent, canActivate: [AuthGuard] },

  // chart routes
  //  { path: 'chart', component: BieudoComponent },

  // user routes
  {
    path: 'users',
    component: OverviewUserComponent, canActivate: [AuthGuard]
  },
  {
    path: 'add-user',
  ...
  {
    path: 'artists',
    component: OverviewArtistComponent,canActivate: [AuthGuard]
  },
  {
    path: 'add-artist',
    component: CreateArtistComponent,canActivate: [AuthGuard]
  },
  {
    path: 'artists/:id/edit',
    component: EditArtistComponent,canActivate: [AuthGuard]
  },
  {
    path: 'artists/:id/delete',
    component: DeleteArtistComponent,canActivate: [AuthGuard]
  },
  {
    path: 'artists/:id/details',
    component: DetailsArtistComponent,canActivate: [AuthGuard]
  },

  //songs routes
  {
    path: 'songs',
    component: OverviewSongComponent,canActivate: [AuthGuard]
  },
  {
    path: 'add-song',
  ...
  {
    path: 'songs/:id/edit',
    component: EditSongComponent,canActivate: [AuthGuard]
  },
  {
    path: 'songs/:id/delete',
    component: DeleteSongComponent,canActivate: [AuthGuard]
  },
  {
    path: 'songs/:id/details',
    component: DetailsSongComponent,canActivate: [AuthGuard]
  },

  //albums routes
  {
    path: 'albums',
    component: OverviewAlbumComponent,canActivate: [AuthGuard]
  },
  {
    path: 'add-album',
    component: CreateAlbumComponent,canActivate: [AuthGuard]
  },
  {
    path: 'albums/:id/edit',
    component: EditAlbumComponent,canActivate: [AuthGuard]
  },
  {
    path: 'albums/:id/delete',
    component: DeleteAlbumComponent,canActivate: [AuthGuard]
  },
  {
    path: 'albums/:id/details',
    component: DetailsAlbumComponent,canActivate: [AuthGuard]
  },

  //playlists routes
  {
    path: 'playlists',
    component: OverviewPlaylistComponent,canActivate: [AuthGuard]
  },
  {
    path: 'add-playlist',
    component: CreatePlaylistComponent,canActivate: [AuthGuard]
  },
  {
    path: 'playlists/:id/edit',
    component: EditPlaylistComponent,canActivate: [AuthGuard]
  },
  {
    path: 'playlists/:id/delete',
    component: DeletePlaylistComponent,canActivate: [AuthGuard]
  },
  {
    path: 'playlists/:id/details',
    component: DetailsPlaylistComponent,canActivate: [AuthGuard]
  },

  //genres routes
  {
    path: 'genres',
    component: OverviewGenreComponent,canActivate: [AuthGuard]
  },
  {
    path: 'add-genres',
    component: CreateGenreComponent,canActivate: [AuthGuard]
  },
  {
    path: 'genres/:id/edit',
    component: EditGenreComponent,canActivate: [AuthGuard]
  },
  {
    path: 'genres/:id/delete',
    component: DeleteGenreComponent,canActivate: [AuthGuard]
  },
  {
    path: 'genres/:id/details',
    component: DetailsGenreComponent,canActivate: [AuthGuard]
  },

  //keywords routes
  {
    path: 'keywords',
    component: OverviewKeywordComponent,canActivate: [AuthGuard]
  },
  {
    path: 'add-keywords',
    component: CreateKeywordComponent,canActivate: [AuthGuard]
  },
  {
    path: 'keywords/:id/edit',
    component: EditKeywordComponent,canActivate: [AuthGuard]
  },
  {
    path: 'keywords/:id/delete',
    component: DeleteKeywordComponent,canActivate: [AuthGuard]
  },
  {
    path: 'keywords/:id/details',
    component: DetailsKeywordComponent,canActivate: [AuthGuard]
  },

  // subjects routes
  {
    path: 'subjects',
    component: OverviewSubjectComponent,canActivate: [AuthGuard]
  },
  {
    path: 'add-subject',
    component: CreateSubjectComponent,canActivate: [AuthGuard]
  },
  {
    path: 'subjects/:id/edit',
    component: EditSubjectComponent,canActivate: [AuthGuard]
  },
  {
    path: 'subjects/:id/delete',
    component: DeleteSubjectComponent,canActivate: [AuthGuard]
  },
  {
    path: 'subjects/:id/details',
    component: DetailsSubjectComponent,canActivate: [AuthGuard]
  },

  // news routes
  {
    path: 'news',
    component: OverviewNewsComponent,canActivate: [AuthGuard]
  },
  {
    path: 'add-news',
    component: CreateNewsComponent,canActivate: [AuthGuard]
  },
  {
    path: 'news/:id/edit',
    component: EditNewsComponent,canActivate: [AuthGuard]
  },
  {
    path: 'news/:id/delete',
    component: DeleteNewsComponent,canActivate: [AuthGuard]
  },
  {
    path: 'news/:id/details',
    component: DetailsNewsComponent,canActivate: [AuthGuard]
  },
