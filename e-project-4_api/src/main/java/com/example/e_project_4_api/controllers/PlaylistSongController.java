...
class PlaylistSongController {
    ...
    @GetMapping("/public/playlist-songs")
    ...
    @GetMapping("/public/playlist-songs/{id}")
    ...
    @DeleteMapping("/public/playlist-songs/{id}")
    ...
    @PostMapping("/public/playlist-songs")
    ...
    @PutMapping("/public/playlist-songs")
